...
import { Target, Calendar, DollarSign, Clock, CheckCircle, AlertCircle, RefreshCw, ChevronDown, Github, ExternalLink, Send } from 'lucide-react'
import { useGetProjectsQuery, useGetProjectMilestonesQuery, useGetProjectSOPsQuery, useGetSOPMilestonesQuery, useSubmitMilestoneMutation } from '../../store/api/projectsApi'
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-3 py-2 bg-[#AD7D56] text-white text-sm font-medium rounded-lg hover:bg-[#8B6344] transition-colors"
                          >
